...
/**
 * pdfprotect restore task that provides all the settings and steps to perform one
 * complete restore of the activity
 */
class restore_pdfprotect_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        ...
        $this->add_step(new restore_pdfprotect_activity_structure_step("pdfprotect_structure", "pdfprotect.xml"));
    }
    ...
    public static function define_decode_contents() {
        $contents = [
            new restore_decode_content("pdfprotect", ["intro"], "pdfprotect"),
        ];
     ...
     * pdfprotect logs. It must return one array
